  ...
  return (
    <div className='flex w-full items-center h-[90vh] relative bg-[url("/hero-1.webp")] bg-cover bg-[position:85%_20%] '>
        ...
        <section className='z-10 w-full h-102 flex flex-col items-center gap-5 text-center text-white! px-6 lg:gap-11 '>
            ...
            <p className='text-white! w-full font-regular text-xl px-2  '>{t('desc')}  <span className='inline md:hidden'>{t('modern')}</span> <span className=' font-light inline md:hidden'>{t('since')}</span></p>
            <p className='hidden md:block w-full font-regular text-xl px-2 -mt-4 lg:-mt-11'>{t('modern')} <span className='font-light'>{t('since')}</span> </p>
            <div>
